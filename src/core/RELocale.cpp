...
#if defined (__RE_OS_WINDOWS__) || defined(__RE_OS_LINUX__) || defined(__RE_OS_ANDROID__)
void RELocale::tryDetectLocale()
{
#warning "//TODO: RELocale::tryDetectLocale() not implemented"
	//TODO: RELocale::tryDetectLocale() not implemented
}
#endif
