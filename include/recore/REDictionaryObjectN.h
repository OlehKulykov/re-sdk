...
#ifndef __REDICTIONARYOBJECTN_H__
#define __REDICTIONARYOBJECTN_H__
...
public:
	...
	virtual REBOOL setValue(REObject * newValue, REObject * key);
	
	virtual REObject * valueForKey(REObject * key);
	
	REDictionaryObjectN();
	
	static REDictionaryObjectN * create();
	
	static REDictionaryObjectN * createWithCapacity(const REUInt32 capacity);
};
