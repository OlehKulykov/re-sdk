...
public:
	...
	virtual void animationDidStarted(const REUIdentifier animationIdentifier) { }
	virtual void animationDidFinished(const REUIdentifier animationIdentifier) { }
	virtual void animationDidStep(const REFloat32 progress);
