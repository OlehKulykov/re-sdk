...
{
public:
	virtual void REAnimationRespondentAnimationDidStarted(const REUIdentifier animationIdentifier) = 0;
	virtual void REAnimationRespondentAnimationDidFinished(const REUIdentifier animationIdentifier) = 0;
	virtual void REAnimationRespondentAnimationDidStep(const REFloat32 progress) = 0;
