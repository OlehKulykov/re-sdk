...
#ifndef __ADD_LIB_CURL_CONFIG_H__
#define __ADD_LIB_CURL_CONFIG_H__
...
//   ./configure --host=arm-apple-darwin9 --disable-curldebug --disable-cookies --without-ssl --without-zlib --without-polarssl --without-cyassl --without-libssh2 --disable-manual --without-gnutls --disable-ldap --disable-file
